import verifyEmailTemplate from './verificationEmail-template.js';
...
export const emailTemplates = [
  {
    label: 'verification',
    // The `generateBody` function now accepts a single argument: the verification link.
    generateBody: (verificationLink) => verifyEmailTemplate(verificationLink),
    // The `generateSubject` function returns a static subject line.
    generateSubject: () => 'Verify Your SubDub Account',
  },
  {
    label: 'resetPassword',
    // The `generateBody` function now accepts a single argument: the verification link.
    generateBody: (resetPasswordLink) =>
      resetPasswordTemplate(resetPasswordLink),
    // The `generateSubject` function returns a static subject line.
    generateSubject: () => 'Reset Password For Your SubDub Account',
  },
  {
